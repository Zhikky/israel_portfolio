  ...
  return (
    <div className="flex flex-col justify-between gap-4 w-full h-fit max-w-[840px] mt-[46px] md:mt-12 lg:mt-18 px-[26px] md:px-8 lg:px-0">
      ...
      <div className="flex flex-col justify-between gap-6 md:gap-10 w-full py-[26px] px-[26px] md:py-18.75 md:px-32.5 rounded-2xl bg-[#2E2E2E]">
        <p className="text-[#FFB05F] font-geist text-sm md:text-base leading-[22px] md:leading-[25px] font-bold">
          {parseText(qualitativeResearch.bodyText.paragraphBody[0])}
        </p>
        ...
        <div>
          <p className="font-rethink-sans italic text-[#8E8E8E] text-lg md:text-[22.22px] font-medium tracking-tighter leading-7 md:leading-9.5">
        ...
        <img className="mt-2 md:mt-4 w-full" src={qualitativeResearch.bodyImg[0]} />
      </div>
    </div>
  );
}