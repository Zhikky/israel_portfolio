...
export default function HeroSection() {
  return (
    ...
    >
      ...
      <div className="relative max-w-[1440px] h-full  px-28 pt-16 pb-10 flex flex-col items-center justify-end ">
        <div className="flex justify-between z-1 w-full flex-wrap relative">
          ...
          <div className="flex flex-col w-9/19">
            <p className="text-white text-2xl font-geist font-medium leading-8">
            ...
            <p className="text-white text-2xl font-geist font-medium leading-8 mt-8">
            ...
            <button className="mt-6 rounded-[50px] text-white border-2 border-white py-5 px-8 text-base leading-none cursor-pointer w-fit font-geist font-semibold hover:scale-103 duration-200">
              Get to know me
            </button>
          </div>
