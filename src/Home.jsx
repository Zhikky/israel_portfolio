      ...
      <section className="flex flex-col max-w-[1440px] w-full py-60 px-38 min-h-300">
        ...
        <div className="flex justify-between mt-9 w-full gap-12">
          <p className="flex-1 text-white text-base font-geist">
            ...
            with a research-driven approach. Alongside my interest in research,
            I recently became a lot more fascinated with Product Strategy and
            have been actively learning and delivering value in that line.
          </p>
          <p className="flex-1 text-white text-base font-geist">
            I am a Product Designer with over 6 years of experience in designing
            digital products. I have a knack for solving complex user problems
        ...
        <div className="flex justify-between w-full max-w-[1440px] p-38">
          <div className="flex flex-col w-7/10 gap-14">
            <p className="text-white text-2xl font-geist w-8/10">
              ...
              or contract). Connect with me & let's push your billion-dollar
              idea to reality
            </p>
